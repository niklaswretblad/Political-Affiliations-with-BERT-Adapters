...
import json
# from adapter_transformers import AdapterType, AdapterConfig, AdapterHelper
...
def BERT(device, train_dataset, test_dataset, freeze_bert=False):
    ...
    adapter_optimizer = torch.optim.AdamW(model.adapter_parameters(), lr=1e-5)
...
def main():
    ...
    train_dataset = SNLIDataset('News_Category_Dataset_v3.json', max_size=5000)
    test_dataset = SNLIDataset('News_Category_Dataset_v3.json', max_size=500)
